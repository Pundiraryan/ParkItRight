    ...
    return (
        <>
            ...
            <div className='grid grid-cols-3 gap-2 md:grid-cols-4 lg:grid-cols-6 mt-2'>
                ...
                <label class="h-24 w-full sm:w-36 sm:mx-36 mb-4 cursor-pointer flex items-center gap-2 sm:gap-3 justify-center border bg-gray-200 rounded-2xl p-2 text-base sm:text-lg text-gray-600">
